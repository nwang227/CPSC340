...
class OptimizerGradientDescent(Optimizer):
    ...
    def __init__(self, optimal_tolerance=1e-2, learning_rate=1e-3, max_evals=100, verbose=False):
        ...
        self.f_old = None
        self.g_old = None
        self.w_old = None  # for heavy ball
...
class OptimizerGradientDescentHeavyBall(OptimizerGradientDescent):

    def __init__(self, momentum, optimal_tolerance=1e-2, learning_rate=1e-3, max_evals=100, verbose=False):
        """
        For A5, I got rid of function object argument. Optimizer and function object are
        theoretically orthogonal, so the fit() methods should ideally associate the two,
        rather than have a redundant association within the constructor.
...
class OptimizerStochasticGradient(Optimizer):
    ...
    def step(self):
        ...
        for batch_is in batches:
            ...
            f, g, w_new, break_yes = self.child_optimizer.step()  # mutates parameters
