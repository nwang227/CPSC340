...
class OptimizerStochasticGradient(Optimizer):
    ...
    def __init__(self, child_optimizer, learning_rate_getter, batch_size, optimal_tolerance=1e-2, learning_rate=1e-3, max_evals=100, verbose=False):
    ...
    def step(self):
        ...
        for batch_is in batches:
            ...
            self.child_optimizer.set_learning_rate(learning_rate / len(batch_is))
